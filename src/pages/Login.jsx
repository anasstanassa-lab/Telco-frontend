...
export default function Login() {
  ...
  const onSubmit = async (e) => {
    ...
    setSubmitting(true);
    try {
      // Session cookie is set by the backend via Set-Cookie; axios withCredentials=true is mandatory.
      ...
      >
        <div className="flex items-center gap-3 mb-5">
          <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
            ...
            <path
              d="M14 1 Q20 8 20 14 Q20 20 14 27 Q8 20 8 14 Q8 8 14 1Z"
              stroke="#3b82f6"
              strokeWidth="1"
              fill="none"
              opacity="0.5"
        ...
        <form onSubmit={onSubmit} className="space-y-3">
          <div>
            ...
            <input
              ...
              className="w-full bg-navy-600 border border-navy-500 rounded-md px-3 py-2 text-xs
